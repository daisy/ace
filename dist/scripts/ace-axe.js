...
daisy.epub.createCFI = function (elem) {
  ...
  } while (currentElement && currentElement.nodeType && currentElement.nodeType == 1 && currentElement.parentNode && currentElement.parentNode.nodeType && currentElement.parentNode.nodeType == 1);
...
daisy.ace.run = function (done) {
  ...
  var addCFIs = function addCFIs(jsonItem) {
      ...
      for (var key in jsonItem) {
        ...
        if (Array.isArray(val)) {
          ...
          for (var i = 0; i < val.length; i++) {
            ...
            if (domMatch && domMatch instanceof Element) {
              //domMatch.nodeType == 1
              try {
