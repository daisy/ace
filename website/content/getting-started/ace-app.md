...
The latest version of the Ace App is 1.0.1. The application installers are distributed via the GitHub development website. Here are convenient download links:
...
Please read the [full release notes](https://github.com/daisy/ace-gui/releases/tag/v1.0.1) at the GitHub development website.
